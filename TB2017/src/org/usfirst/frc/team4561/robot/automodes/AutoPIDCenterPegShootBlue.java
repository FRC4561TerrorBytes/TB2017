...
import org.usfirst.frc.team4561.robot.commands.AutoShootMaximumPower;
 ...
 *
 */
public class AutoPIDCenterPegShootBlue extends CommandGroup {
 
    public AutoPIDCenterPegShootBlue() {
        // Add Commands here:
...
//        }
    	...
    	addSequential(new DriveTankTimed(0.65, 0.65, 3.5));
    	//addSequential(new WaitCommand(1));
    	addSequential(new GearHolderOpen());
    	//addSequential(new WaitCommand(1));
    	addSequential(new GearCoverOpen());
    	addSequential(new DriveTankTimed(-0.65, -0.65, 2));
    	addSequential(new DriveTankTimed(0.8, 0.8, 0.25));
    	addSequential(new DriveTankTimed(-0.4, 0.4, 1.2));
    	addSequential(new ToggleDriveTrainPIDOff());
    	addParallel(new AutoShootMaximumPower()); //spin up flywheel
        addSequential(new WaitCommand(2));
